...
namespace GameEngine
{
		...
		PlatformLoop(PlatformLoopFunc)
	{
		...
		*/
		...
		ImGui_ImplDX12_Init((ID3D12Device*)m_renderThread->GetRHI()->GetDevice()->GetNativeObject(), RenderCore::g_FrameBufferCount, (DXGI_FORMAT)m_renderThread->GetRHI()->GetSwapChain()->GetRTFormat(),
			YOUR_SRV_DESC_HEAP,
